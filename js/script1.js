let word, incorrectLetters=[], correctLetters = [], guess;
...
function randomWord () {
    ...
    let noOfLetters = ranObj.word.length;
    ...
    hintText.innerHTML = ranObj.hint.toLocaleUpperCase();
...
inputs.addEventListener("click", () => typingInput.focus()); // focus on input field when clicked on inputs
document.addEventListener("keydown", () => typingInput.focus()); // on key press focus shifts to typing-input text field